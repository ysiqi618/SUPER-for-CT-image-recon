function [net, info] = cnn_train_fbpconvnetnoreg(net, imdb, getBatch, beta, delta, mu_para, block, Outer, numepoch, katype,varargin)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% load kappa, denom, sinogram, and weight matrix for training and 
% validation datasets here.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
