% -------------------------------------------------------------------------
function [net, info] = cnn_CT_denoising_rnn_prevLyrInit(imdb,overlap,layer_start,Layer,varargin)
% -------------------------------------------------------------------------
...
switch opts.networkType
    case 'simplenn', trainFn = @cnn_train_modified_rnn_prevLyrInit;
    case 'dagnn', trainFn = @cnn_train_dag;
end

[net, info] = trainFn(net, imdb, getBatch(opts),overlap,layer_start,Layer,...
    'expDir', opts.expDir, ...
    net.meta.trainOpts, ...
    opts.train, ...
