function [net, info] = cnn_fbpconvnetnoreg(beta, delta, mu_para, block, Outer, numepoch, katype, varargin)
...
switch opts.networkType
    case 'simplenn', trainFn = @cnn_train_fbpconvnetnoreg;
    case 'dagnn', trainFn = @cnn_train_dag ;
end

[net, info] = trainFn(net, imdb, getBatch(opts), beta,delta,mu_para, block,Outer,numepoch,katype,...
    'expDir', opts.expDir, ...
    net.meta.trainOpts, ...
    opts.train, ...
