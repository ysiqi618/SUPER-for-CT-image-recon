function [net, info] = cnn_fbpconvnet_pure(numepoch, varargin)
...
switch opts.networkType
    case 'simplenn', trainFn = @cnn_train_fbpconvnet_pure;
    case 'dagnn', trainFn = @cnn_train_dag ;
end

[net, info] = trainFn(net, imdb, getBatch(opts),beta,gamma,block,InIter,Outer,numepoch, clu,katype,...
