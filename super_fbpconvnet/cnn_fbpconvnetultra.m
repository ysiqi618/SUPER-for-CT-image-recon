function [net, info] = cnn_fbpconvnetultra(beta, gamma, mu_para, block, InIter, Outer, numepoch, clu, katype,...
...
switch opts.networkType
    case 'simplenn', trainFn = @cnn_train_fbpconvnetultra;
    case 'dagnn', trainFn = @cnn_train_dag ;
end

[net, info] = trainFn(net, imdb, getBatch(opts), beta,gamma,mu_para, block,InIter,Outer,numepoch, clu,katype,...
    decay_beta,decay_gamma,decay_epoch_beta,decay_epoch_gamma,'expDir', opts.expDir, ...
    net.meta.trainOpts, ...
    opts.train, ...
